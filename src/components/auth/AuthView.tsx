          ...
          {view === "register" && (
            <>
              ...
              <div className="relative font-bold uppercase">
                ...
                <select className="w-full pl-10 pr-4 py-3 rounded-lg login-input outline-none text-sm bg-slate-900 text-slate-300 font-bold" onChange={e=>setForm({...form, unit:e.target.value})}>
