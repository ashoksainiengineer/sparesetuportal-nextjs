                ...
                <div className="bg-white rounded-2xl shadow-md border border-slate-200 overflow-hidden">
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left text-[9px] divide-y divide-slate-100 font-mono">
                            <thead className="bg-slate-50 text-[8.5px] font-black text-slate-400 tracking-widest uppercase"><tr><th className="p-4">Txn ID</th><th className="p-4">Material Details</th><th className="p-4 text-center">Qty</th><th className="p-4">Info</th><th className="p-4 text-center">Status</th></tr></thead>
                ...
                <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden animate-scale-in">
                  ...
                  <div className="p-6 space-y-4 font-bold uppercase">
                    <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
                      <p className="text-[9px] text-slate-400 font-black uppercase mb-1 tracking-widest uppercase">Transaction Details</p>
                      <p className="text-[13px] font-bold text-slate-800 leading-tight">{actionModal.data.item_name}</p>
